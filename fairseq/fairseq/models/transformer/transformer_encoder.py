...
class TransformerEncoderBase(FairseqEncoder):
    ...
    def __init__(self, cfg, dictionary, embed_tokens, return_fc=False, linguistic_encoder=False):
        self.cfg = cfg
        ...
        if linguistic_encoder:
            self.layers.extend(
                [self.build_encoder_layer(cfg, linguistic_encoder) for i in range(cfg.linguistic_encoder.layers)]
            )
        else:
            self.layers.extend(
    ...
    def build_encoder_layer(self, cfg, linguistic_encoder=False):
        layer = transformer_layer.TransformerEncoderLayerBase(
            cfg, return_fc=self.return_fc, linguistic_encoder=linguistic_encoder
        )
